 ...
 *
 * Description: 
 *  - Implementation for UDP command server (port 12345)
 *  - Responds to simple text commands from host to query status or stop program
 *      - i.e. help, ?, count, length, dips, history, stop, <enter>, unknown.
